        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    order_of_execution = table.Column<int>(type: "int", nullable: false),
                    object_of_labor_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    technological_procedure_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    current_technological_procedure = table.Column<int>(type: "int", nullable: false),
                    current_technological_procedure_executed = table.Column<bool>(type: "bit", nullable: false),
                    employee_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    object_of_labor_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("256e2761-b05b-4404-8b44-b463ed2a2e83"), "Administracija" });

            migrationBuilder.InsertData(
                table: "workplace",
                columns: new[] { "workplace_id", "workplace_name" },
                values: new object[,]
                {
                    { new Guid("1e3f19e6-d318-4e2a-a294-7d8af9b58952"), "Menadzer" },
                    { new Guid("6039d269-cff0-4471-8ce6-462d5712e78f"), "Admin" },
                    { new Guid("8bafd265-7f83-4f19-adae-43ed986a517a"), "Radnik u proizvodnji" }
                });
